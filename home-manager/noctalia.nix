...

{
  programs.noctalia-shell = {
    ...
    # All your current Noctalia settings live here (or loaded from JSON)
    settings = {
      settingsVersion = 59;
      ...
      bar = {
        ...
        widgets = {
          left = [
            { iconColor = "error"; id = "SessionMenu"; }
            {
              clockColor = "error";
      ...
      general = {
        avatarImage = "/home/dairozero/Pictures/A2CB4912-8E78-433B-8964-EEDC79BB18C0.jpeg";
        dimmerOpacity = 0;
      ...
      wallpaper = {
        ...
        directory = "/home/dairozero/Pictures/wallpaper";
        monitorDirectories = [];
